...
public static class Localization
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["BatteryMonitorStaticDescription"] = "Show only the headset icon without animation.\nA charging indicator is displayed when the headset is being charged.",
        ...
        ["BatteryMonitorCustomDescription"] = "Change the icon color based on the battery level with customizable colors and levels.",
        ...
        ["Preview"] = "Preview",
        ["PreviewDescription"] = "This is how the icon will look at different battery levels.",
    ...
    private static readonly Dictionary<string, string> Portuguese = new()
    {
        ...
        ["BatteryMonitorStaticDescription"] = "Exibe apenas o ícone do headset, sem animação.\nUm indicador de carregamento é exibido quando o headset está sendo carregado.",
        ...
        ["BatteryMonitorCustomDescription"] = "Altere a cor do ícone com base no nível da bateria, com cores e níveis personalizáveis.",
        ...
        ["PreviewDescription"] = "Veja como o ícone ficará em diferentes níveis de bateria.",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["BatteryMonitorStaticDescription"] = "Muestra solo el icono de los auriculares, sin animación.\nSe muestra un indicador de carga cuando los auriculares se están cargando.",
        ...
        ["BatteryMonitorCustomDescription"] = "Cambia el color del icono según el nivel de batería, con colores y niveles personalizables.",
        ["BatteryMonitorCustomize"] = "Personalizar",
        ...
        ["PreviewDescription"] = "Así se verá el icono en diferentes niveles de batería.",
