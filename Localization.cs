...
public static class Localization
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["NotifyWhenFullyChargedDescription"] = "Show a notification when the headset is charging and reaches 100%.",
    ...
    private static readonly Dictionary<string, string> Portuguese = new()
    {
        ...
        ["NotifyWhenFullyChargedDescription"] = "Mostrar uma notificação quando o headset estiver carregando e atingir 100%.",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["NotifyWhenFullyChargedDescription"] = "Mostrar una notificación cuando los auriculares estén cargándose y alcancen el 100%.",
